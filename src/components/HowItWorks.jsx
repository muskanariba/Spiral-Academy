...
//               {/* Badge */}
//               <div
//                 className={`absolute -top-3 sm:-top-5 left-3 sm:left-4 px-2 sm:px-3 py-1 text-xs sm:text-sm font-semibold text-white
...
//               {/* Card */}
//               <div className="bg-white border border-[#2F5AA8] rounded-[18px] p-4 sm:p-6 pt-8 sm:pt-10 text-left h-full flex flex-col justify-start">
//                 <h3 className="text-[15px] sm:text-[16px] font-semibold text-gray-800">
//                   {step.title}
//                 </h3>
