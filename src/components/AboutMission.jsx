...
export default function AboutMission() {
  return (
    <div className="w-full flex justify-center">
      <div className="
        w-full max-w-[1440px] 
        px-4 sm:px-6 md:px-10 lg:px-[79px] 
      ...
      ">
        ...
        <div className="
          w-full lg:w-[717px] 
          flex flex-col 
          gap-6 lg:gap-[28.94px]
        ">

          {/* Heading */}
          <h2 className="
            font-bold 
            text-2xl sm:text-3xl md:text-4xl lg:text-[45.5px] 
        ...
        {/* RIGHT IMAGE SECTION */}
        <div className="
          w-full sm:w-[400px] md:w-[450px] lg:w-[470px] 
          h-[300px] sm:h-[400px] md:h-[480px] lg:h-[516px] 
          relative
        ">
